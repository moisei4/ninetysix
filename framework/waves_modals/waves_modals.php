...
function waves_modal_before($class){ ?>
    <div class="waves-modal-item waves-va-middle <?php echo esc_attr(str_replace('_','-',$class)); ?>"><div class="container"><div class="row"><?php
}
function waves_modal_after(){ ?></div></div></div><?php }
