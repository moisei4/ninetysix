...
function waves_social_name($url){
    if(strpos($url,'twitter.com')) {$social['name']='twitter';$social['class']='ion-social-twitter';return $social;}
    if(strpos($url,'linkedin.com')){$social['name']='linkedin';$social['class']='ion-social-linkedin';return $social;}
    if(strpos($url,'facebook.com')){$social['name']='facebook';$social['class']='ion-social-facebook';return $social;}
    if(strpos($url,'delicious.com')){$social['name']='delicious';$social['class']='ion-social-delicious';return $social;}
    if(strpos($url,'codepen.io')){$social['name']='codepen';$social['class']='ion-social-codepen';return $social;}
    if(strpos($url,'github.com')){$social['name']='github';$social['class']='ion-social-github';return $social;}
    if(strpos($url,'wordpress.org')||strpos($url,'wordpress.com')){$social['name']='wordpress';$social['class']='ion-social-wordpress';return $social;}
    if(strpos($url,'youtube.com')){$social['name']='youtube';$social['class']='ion-social-youtube-play';return $social;}
    if(strpos($url,'behance.net')){$social['name']='behance';$social['class']='ion-social-behance';return $social;}
    if(strpos($url,'pinterest.com')){$social['name']='pinterest';$social['class']='ion-social-pinterest';return $social;}
    if(strpos($url,'foursquare.com')){$social['name']='foursquare';$social['class']='ion-social-foursquare';return $social;}
    if(strpos($url,'soundcloud.com')){$social['name']='soundcloud';$social['class']='ion-social-soundcloud';return $social;}
    if(strpos($url,'dribbble.com')){$social['name']='dribbble';$social['class']='ion-social-dribbble';return $social;}
    if(strpos($url,'instagram.com')){$social['name']='instagram';$social['class']='ion-social-instagram';return $social;}
    if(strpos($url,'plus.google')){$social['name']='google';$social['class']='ion-social-googleplus';return $social;}
    if(strpos($url,'vimeo.com')){$social['name']='vimeo';$social['class']='ion-social-vimeo';return $social;}
    if(strpos($url,'twitch.tv')){$social['name']='twitch';$social['class']='ion-social-twitch';return $social;}
    if(strpos($url,'tumblr.com')){$social['name']='tumblr';$social['class']='ion-social-tumblr';return $social;}
    if(strpos($url,'trello.com')){$social['name']='trello';$social['class']='ion-social-trello';return $social;}
    if(strpos($url,'spotify.com')){$social['name']='spotify';$social['class']='ion-social-spotify';return $social;}
    if(strpos($url,'rss')){$social['name']='feed';$social['class']='ion-social-rss';return $social;}
